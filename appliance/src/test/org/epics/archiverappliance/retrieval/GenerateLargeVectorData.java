...
public class GenerateLargeVectorData {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 2) {
            System.err.println(
                    "Usage: java org.epics.archiverappliance.retrieval.GenerateLargeVectorData <pvName> <folder>");
            return;
        }
        ...
        String pluginURL = pluginString(
                PB_PLUGIN_IDENTIFIER,
                "localhost",
                "name=LTS&rootFolder=" + folder + "&partitionGranularity=PARTITION_DAY");
