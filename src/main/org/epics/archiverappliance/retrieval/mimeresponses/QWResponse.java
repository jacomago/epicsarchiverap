...
public class QWResponse implements MimeResponse {
    ...
    public void consumeEvent(Event e) throws Exception {
        ...
        out.print("{ \"millis\": "
                + (evnt.getEpochSeconds() * 1000 + evnt.getEventTimeStamp().getNano() / 1000000)
                + ", \"val\": " + valJS
    ...
    public void processingPV(
        ...
        buf.append("{ \"meta\": { \"name\": \"")
                .append(retrievalContext.getPvNameFromRequest())
                .append("\" ");
        if (streamDesc != null) {
            buf.append(", \"waveform\": ")
                    .append(Boolean.toString(remoteDesc.getArchDBRType().isWaveForm()))
                    .append(" ");
