...
public class RawDataRetrievalAsEventStream implements DataRetrievalForPVs {
    ...
    @Override
    public EventStream getDataForPVS(
            String[] pvNames, Instant startTime, Instant endTime, RetrievalEventProcessor retrievalEventProcessor) {
    ...
    public EventStream getDataForPVS(
        ...
        buf.append(accessURL)
                .append("?pv=")
                .append(concatedPVs.toString())
                .append("&from=")
                .append(TimeUtils.convertToISO8601String(startTime))
                .append("&to=")
                .append(TimeUtils.convertToISO8601String(endTime));
