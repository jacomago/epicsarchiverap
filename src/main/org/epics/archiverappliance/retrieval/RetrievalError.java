...
public class RetrievalError {
    ...
    public static boolean check(boolean booleanCheck, String msg, HttpServletResponse resp, int scServiceUnavailable)
            throws IOException {
        return check(booleanCheck, msg, resp, scServiceUnavailable, null);
    }

    public static boolean check(boolean booleanCheck, String msg, HttpServletResponse resp, int sc, Exception ex)
            throws IOException {
        if (booleanCheck) {
