...
public class ArchiverValuesHandler implements XMLRPCStaxProcessor, EventStream, Iterator<Event>, RemotableOverRaw {
     ...
     */
    private final Map<String, String> metaInformation = new HashMap<String, String>();
    /**
    ...
    public boolean endElement(String localName, String value) {
        ...
        if (inValues) {
            if (localName.equals("struct") && (workingCopyOfEvent != null)) {
                ...
                try {
                    currentEvent = DefaultEvent.fromDBREvent(new HashMapEvent(dbrType, workingCopyOfEvent));
                ...
                if (lastTwoNodes.equals("value.i4")
                    ...
                    if (lastName.equals("value")
                            && Objects.requireNonNull(dbrType).isWaveForm()) {
