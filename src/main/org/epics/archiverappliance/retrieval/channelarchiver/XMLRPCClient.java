...
public class XMLRPCClient {
    private static Logger logger = LogManager.getLogger(XMLRPCClient.class.getName());
    /**
     ...
     */
    private static void doHTTPPostAndCallSAXHandler(String serverURL, DefaultHandler handler, StringEntity postEntity)
