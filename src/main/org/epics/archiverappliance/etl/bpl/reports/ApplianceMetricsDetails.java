            ...
            for (ETLMetricsForLifetime metricForLifetime : metricsForLifetime) {
                ...
                if (totalRunsNum != 0) {
                    ...
                    addDetailedStatus(
                            ...
                            twoSignificantDigits.format(avgETLTimeInSeconds));
                    ...
                    addDetailedStatus(
                            ...
                            twoSignificantDigits.format(((double) metricForLifetime.getTimeinMillSecond4getETLStreams())
                                    / (1000.0 * totalRunsNum)));
                    addDetailedStatus(
                            details,
                            "Avg time spent by free space checks in ETL(" + lifetimeIdentifier + ") (s/run)",
                            twoSignificantDigits.format(((double) metricForLifetime.getTimeinMillSecond4checkSizes())
                                    / (1000.0 * totalRunsNum)));
                    addDetailedStatus(
                            details,
                            "Avg time spent by prepareForNewPartition() in ETL(" + lifetimeIdentifier + ") (s/run)",
                            twoSignificantDigits.format(
                                    ((double) metricForLifetime.getTimeinMillSecond4prepareForNewPartition())
                                            / (1000.0 * totalRunsNum)));
                    addDetailedStatus(
                            details,
                            "Avg time spent by appendToETLAppendData() in ETL(" + lifetimeIdentifier + ") (s/run)",
                            twoSignificantDigits.format(
                                    ((double) metricForLifetime.getTimeinMillSecond4appendToETLAppendData())
                                            / (1000.0 * totalRunsNum)));
                    addDetailedStatus(
                            details,
                            "Avg time spent by commitETLAppendData() in ETL(" + lifetimeIdentifier + ") (s/run)",
                            twoSignificantDigits.format(
                                    ((double) metricForLifetime.getTimeinMillSecond4commitETLAppendData())
                                            / (1000.0 * totalRunsNum)));
                    addDetailedStatus(
                            details,
                            "Avg time spent by markForDeletion() in ETL(" + lifetimeIdentifier + ") (s/run)",
                            twoSignificantDigits.format(
                                    ((double) metricForLifetime.getTimeinMillSecond4markForDeletion())
                                            / (1000.0 * totalRunsNum)));
                    addDetailedStatus(
                            details,
                            "Avg time spent by runPostProcessors() in ETL(" + lifetimeIdentifier + ") (s/run)",
                            twoSignificantDigits.format(
                                    ((double) metricForLifetime.getTimeinMillSecond4runPostProcessors())
                                            / (1000.0 * totalRunsNum)));
                    addDetailedStatus(
                            details,
                            "Avg time spent by executePostETLTasks() in ETL(" + lifetimeIdentifier + ") (s/run)",
                            twoSignificantDigits.format(
                                    ((double) metricForLifetime.getTimeinMillSecond4executePostETLTasks())
                                            / (1000.0 * totalRunsNum)));
