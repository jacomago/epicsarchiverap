...
public class ETLMetricsForLifetime implements StorageMetricsContext {
    ...
    public double getWeeklyETLUsageInPercent() {
        long epochSeconds = System.currentTimeMillis() / 1000;
        long startOfEpochDayInSeconds = (epochSeconds / (PartitionGranularity.PARTITION_DAY.getApproxSecondsPerChunk()))
        ...
        long totalSecondsInMetric =
                totalDaysInMetric * (PartitionGranularity.PARTITION_DAY.getApproxSecondsPerChunk()) + secondsIntoDay;
        logger.debug(
