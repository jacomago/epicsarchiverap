...
public class JCAConfigGen {
     ...
     */
    public static ByteArrayInputStream generateJCAConfig(InstallationProperties installationProperties)
        ...
        if (props != null
            ...
            configlogger.fatal(
                    "We no longer support the native version of JCA in the EPICS archiver appliance. Please use CAJ instead.");
        ...
        String dispatcher = props.getProperty(
                "org.epics.archiverappliance.engine.epics.JCAConfigGen.dispatcher",
