...
public class JCAEventDispatcherBasedOnPVName extends AbstractEventDispatcher {
    ...
    ExecutorService[] pvNameEventsHandlers =
            new ExecutorService[Math.max(Runtime.getRuntime().availableProcessors() / 4, 4)];
    ...
    public void dispatch(ConnectionEvent arg0, List arg1) {
        ...
        try {
            pvNameEventsHandlers[threadId].submit(
                    new Runnable() {
