...
public class PVContext {
    ...
    /** map of channels. */
    private static HashMap<String, RefCountedChannel> channels = new HashMap<String, RefCountedChannel>();
     ...
     * @see #releaseChannel
     */
    public static synchronized RefCountedChannel getChannel(
        ...
        if (channel_ref == null) {
            ...
            if (channel == null) throw new Exception("Cannot create channel '" + name + "'");
     ...
     */
    static synchronized void releaseChannel(final RefCountedChannel channel_ref, final ConnectionListener conn_callback)
    ...
    public static void scheduleCommand(
            String pvName, int jcaCommandThreadId, RefCountedChannel channel_ref, String msg, final Runnable command) {
        try {
