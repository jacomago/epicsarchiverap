...
public class PVMetrics {
     ...
     */
    public DBRTimeEvent addConnectionLostRegainedFields(DBRTimeEvent event) {
        ...
        if (firstDataAfterStartUp) {
            ...
            fieldValues.put("cnxlostepsecs", Long.toString(connectionLastLostEpochSeconds));
            fieldValues.put("cnxregainedepsecs", Long.toString(cnxregainedsecs));
            fieldValues.put("startup", Boolean.TRUE.toString());
            connectionLastLostEpochSeconds = 0;
        ...
        return event.cloneWithExtraFieldValues(fieldValues, false);
    }
