...
public class PVMetrics {
    ...
    public LinkedList<Map<String, String>> getDetailedStatus() {
        ...
        double estimatedStorageRateInKiloBytesPerHour =
                this.getStorageRate() * PartitionGranularity.PARTITION_HOUR.getApproxSecondsPerChunk() / 1024;
        addDetailedStatus(
                statuses,
        ...
        double estimatedStorageRateInMegaBytesPerDay =
                this.getStorageRate() * PartitionGranularity.PARTITION_DAY.getApproxSecondsPerChunk() / (1024 * 1024);
        addDetailedStatus(
                statuses,
        ...
        double estimatedStorageRateInGigaBytesPerYear = this.getStorageRate()
