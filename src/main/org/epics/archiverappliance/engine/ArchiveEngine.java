...
public class ArchiveEngine {
     ...
     * @throws Exception On error in getting the pv info and status .
     */
     ...
     *
     * @param pvName          Name of the channel (PV)
     * @param samplingPeriod  new sampling Period of the channel (PV)
     * @param mode            scan or monitor
     * @param configservice   ConfigService
     * @param writer          the writer to protocol buffer
     * @param usePVAccess     Should we use PVAccess to connect to this PV.
