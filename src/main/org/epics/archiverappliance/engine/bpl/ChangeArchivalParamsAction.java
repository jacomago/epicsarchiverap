...
public class ChangeArchivalParamsAction implements BPLAction {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp, ConfigService configService)
        ...
        if (samplingPeriodStr == null || samplingPeriodStr.isEmpty()) {
            resp.sendError(HttpServletResponse.SC_BAD_REQUEST);
            return;
        }
        ...
        if (samplingMethodStr == null || samplingMethodStr.isEmpty()) {
            resp.sendError(HttpServletResponse.SC_BAD_REQUEST);
            return;
        }
        ...
        if (firstDestURL == null || firstDestURL.isEmpty()) {
        ...
        try {
            logger.debug("Changing the archival parameters for pv " + pvName + " to a sampling period of "
