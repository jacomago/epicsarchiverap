...
public class ThrottledLogger {
    ...
    private static final Logger logger = LogManager.getLogger(ThrottledLogger.class);
    /** Log level */
     ...
     */
    public ThrottledLogger(final LogLevel level, final double seconds_between_messages) {
        this.level = level;
    ...
    public boolean log(final String message) {
        if (throttle.isPermitted()) { // OK, show
