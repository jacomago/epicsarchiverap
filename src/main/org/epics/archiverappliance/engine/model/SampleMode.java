...
public class SampleMode {
    ...
    public String toString() {
        if (monitor) {
            if (delta > 0.0) return "Monitor [threshold " + delta + "] @ min. period " + period + " sec";
            else return "Monitor @ min. period " + period + " sec";
        } else return "Scan @ " + period + " sec";
    }
}
