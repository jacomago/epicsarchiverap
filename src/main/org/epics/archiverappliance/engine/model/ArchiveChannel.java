...
public abstract class ArchiveChannel {
    ...
    protected final void addValueToBuffer(final DBRTimeEvent timeevent) {
        ...
        var updatedTimeEvent = this.pvMetrics.addConnectionLostRegainedFields(timeevent);
        ...
        synchronized (this) {
            this.lastDBRTimeEvent = updatedTimeEvent;
    ...
    public DBRTimeEvent aboutToWriteBuffer(DBRTimeEvent lastSample) {
        if (this.pv != null) {
            return this.pv.aboutToWriteBuffer(lastSample);
        }
        return lastSample;
    }
}
