...
public class PvaMgmtService implements RPCService {
    ...
    private static final Logger logger = LogManager.getLogger(PvaMgmtService.class.getName());
    ...
    public PVAStructure call(PVAStructure args) throws Exception {
        ...
        if (uri != null) {
            ...
            throw new IllegalArgumentException(
                    PVA_MGMT_SERVICE + " only supports request args of type NTURI or NTTable ");
        }
    }
}
