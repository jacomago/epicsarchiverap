    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp, ConfigService configService)
        ...
        if (plugin_url == null || plugin_url.isEmpty()) {
            resp.sendError(
                    ...
                    "Please specify the new storage specification as the plugin_url argument");
            return;
        }
        ...
        logger.info(
                "Replacing plugin URL for " + storage + " for PV " + pvName + " with store definition " + plugin_url);
        ...
        try (PrintWriter out = resp.getWriter()) {
            ...
            resp.sendError(
                    HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Exception updating typeinfo for pv " + pvName);
        }
    }
}
