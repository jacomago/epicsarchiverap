...
public class PauseArchivingPV implements BPLAction {
    ...
    private void pauseSinglePV(HttpServletRequest req, HttpServletResponse resp, ConfigService configService)
        ...
        if (info == null) {
            ...
            String enginePauseURL =
                    info.getEngineURL() + "/pauseArchivingPV" + "?pv=" + URLEncoder.encode(pvName, "UTF-8");
