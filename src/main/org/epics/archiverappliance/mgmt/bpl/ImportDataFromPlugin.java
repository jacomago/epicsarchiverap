...
public class ImportDataFromPlugin implements BPLAction {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp, ConfigService configService)
        ...
        if (srcStoragePluginURL == null || srcStoragePluginURL.isEmpty()) {
        ...
        if (destStoragePluginName == null || destStoragePluginName.isEmpty()) {
        ...
        try (BasicContext context = new BasicContext();
                EventStream strm = new CurrentThreadWorkerEventStream(
                        pvName,
                        srcPlugin.getDataForPV(context, pvName, startTime, endTime, new DefaultRawPostProcessor()))) {
