...
public class ArchivePVState {
    ...
    public boolean hasNotConnectedSoFar() {
        return this.currentState.equals(ArchivePVStateMachine.START)
                || this.currentState.equals(ArchivePVStateMachine.METAINFO_REQUESTED)
                || this.currentState.equals(ArchivePVStateMachine.METAINFO_GATHERING)
                || this.currentState.equals(ArchivePVStateMachine.ABORTED);
    }
