    ...
    public SampleValue getSampleValue(ArchDBRTypes type, int secondsIntoYear) {
        ...
        return switch (type) {
            ...
            case DBR_WAVEFORM_STRING -> new VectorStringSampleValue(
                    Collections.nCopies(NUM_COPIES, Double.toString(sineval)));
            case DBR_WAVEFORM_SHORT, DBR_WAVEFORM_ENUM -> new VectorValue<Short>(
                    Collections.nCopies(NUM_COPIES, (short) (Short.MAX_VALUE * sineval)));
            ...
            case DBR_WAVEFORM_BYTE -> new VectorValue<Byte>(
                    Collections.nCopies(NUM_COPIES, (byte) (Byte.MAX_VALUE * sineval)));
            case DBR_WAVEFORM_INT -> new VectorValue<Integer>(
                    Collections.nCopies(NUM_COPIES, (int) (Integer.MAX_VALUE * sineval)));
