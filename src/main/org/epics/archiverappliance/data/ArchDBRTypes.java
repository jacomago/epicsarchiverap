...
public enum ArchDBRTypes {
    ...
    private static final HashMap<PayloadType, ArchDBRTypes> PBTypeReverseMapping =
            new HashMap<PayloadType, ArchDBRTypes>();
     ...
     */
    ArchDBRTypes(
            int fromdbaccess_h, boolean isWaveform, String primitivename, PayloadType payloadType, boolean isV3Type) {
