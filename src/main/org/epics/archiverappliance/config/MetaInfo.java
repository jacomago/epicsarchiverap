    ...
    private void updateTypeInfo(String pvName, ConfigService configService) {
        ...
        if (typeInfo != null) {
            if ((typeInfo.getUnits() == null && this.unit != null)
                    || (typeInfo.getUnits() != null
                            && this.unit != null
                            && !typeInfo.getUnits().equals(this.unit))) {
                configLogger.info("Updating units and precision for pv " + pvName + " to " + this.unit + " and "
                        + this.precision);
            ...
            if (typeInfo.getHostName() == null
                    || (typeInfo.getHostName() == null
                            && this.hostName != null
                            && !this.hostName.equals(typeInfo.getHostName()))) {
