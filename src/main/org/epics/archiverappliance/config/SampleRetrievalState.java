...
public class SampleRetrievalState extends RetrievalState {
    ...
    private List<DataSourceforPV> getUnitTestDataSources(String pvName) throws IOException {
        ...
        PlainPBStoragePlugin mediumTermStore = (PlainPBStoragePlugin) StoragePluginURLParser.parseStoragePlugin(
        ...
        PlainPBStoragePlugin shortTermStore = (PlainPBStoragePlugin) StoragePluginURLParser.parseStoragePlugin(
