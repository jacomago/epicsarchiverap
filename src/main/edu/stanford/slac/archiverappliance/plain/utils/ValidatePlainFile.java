...
public class ValidatePlainFile {
    ...
    public static boolean validatePlainFile(Path path, boolean verboseMode)
        throws IOException {
        return validatePlainFile(path, verboseMode, new PBPlainFileHandler());
    }

    public static boolean validatePlainFile(Path path, boolean verboseMode, PlainFileHandler handler)
            throws IOException {
