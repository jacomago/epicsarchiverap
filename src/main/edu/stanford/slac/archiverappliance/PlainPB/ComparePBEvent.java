...
public class ComparePBEvent implements CompareEventLine {
    ...
    public NextStep compare(byte[] line1, byte[] line2) throws IOException {
        ...
        try {
            ...
            PartionedTime e =
                    DefaultEvent.fromByteArray(type, this.yearSecondTimestamp.getYear(), new ByteArray(line1));
            line1Timestamp = e.getYearSecondTimestamp();
            if (line2 != null) {
                PartionedTime e2 =
                        DefaultEvent.fromByteArray(type, this.yearSecondTimestamp.getYear(), new ByteArray(line2));
