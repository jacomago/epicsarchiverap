 ...
 */
class ZipFetchTest {
    private static final Logger logger = LogManager.getLogger(ZipFetchTest.class.getName());
    ...
    private final byte[] data = new byte[SAMPLE_SIZE];
    ...
    @Test
    void compareSpeedup() throws Exception {
    ...
    private record ParallelFetch(byte[] data, int day) implements Callable<Integer> {
