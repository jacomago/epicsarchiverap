    ...
    public void getApplianceInfo() {
        ...
        try {
            ...
            */
            ...
            String[] expectedValues = new String[] {"appliance0", MGMT_URL, ENGINE_URL, RETRIEVAL_URL, ETL_URL};
            logger.info("results" + result.toString());
            Assertions.assertArrayEquals(
                    expextedKeys,
                    NTUtil.extractStringArray(PVATable.fromStructure(result).getColumn("Key")));
            Assertions.assertArrayEquals(
                    expectedValues,
                    NTUtil.extractStringArray(PVATable.fromStructure(result).getColumn("Value")));
        } catch (Exception e) {
            e.printStackTrace();
