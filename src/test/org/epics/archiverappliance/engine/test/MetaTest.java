...
public class MetaTest {
    ...
    public void testAliasNames() {
        ...
        for (String pvName : aliasNames.keySet()) {
            ...
            Assertions.assertTrue(
                    aliasName.expectedName.equals(aliasName.metaGetAliasName),
                    "AliasName for " + pvName + " is not " + aliasName.expectedName + ". Instead it is "
                            + aliasName.metaGetAliasName);
            Assertions.assertTrue(
                    aliasName.expectedName.equals(aliasName.metaGetOtherInfoName),
    ...
    private void testAliasNamesForPV(
            final CountDownLatch latch, final String pvName, HashMap<String, AliasNames> aliasNames) {
        String[] metaFied = {"MDEL", "ADEL", "RTYP"};
        try {
