...
public class SimpleCAMonitor {
    ...
    public static ByteArrayInputStream generateJCAConfiguration() {
        ...
        return new ByteArrayInputStream(cfgbytes);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        Channel channel = jca_context.createChannel(pvName, ev -> {
        ...
        latch1.await();
        channel.addMonitor(
                DBR_Helper.getTimeType(false, channel.getFieldType()),
                channel.getElementCount(),
                MonitorMask.ARCHIVE.getMask(),
                ev -> {
                    ...
                    try {
                        ...
                        DBRTimeEvent dbrtimeevent = DefaultEvent.fromDBR(generatedDBRType, dbr, Map.of(), false);
