...
public class ChannelTest {
    ...
    void getPVdata() {
        ...
        try {
            ...
            Assertions.assertFalse(samples.isEmpty(), "there is no data in sample buffer");
            ArchiveEngine.destoryPv(pvName, testConfigService);
        } catch (Exception e) {
            logger.error("Exception", e);
        }
