...
public class LineByteStreamByteArrayTest {
    private static final Logger logger = LogManager.getLogger(LineByteStreamByteArrayTest.class.getName());
    ...
    public void testLineByteStream() throws Exception {
        ...
        logger.info("Finished Generate file");
    ...
    public void testLastAndFirstLinesWithBoundedStream() throws Exception {
        ...
        {
            logger.info("Testing keeping the start fixed and varying the end for filesize {}", fileSize);
            long start = 0;
