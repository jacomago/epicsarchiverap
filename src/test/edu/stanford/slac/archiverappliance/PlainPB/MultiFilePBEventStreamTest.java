...
public class MultiFilePBEventStreamTest {
    ...
    public void testMultiFileEventStream(FileExtension fileExtension, PartitionGranularity granularity)
            throws Exception {
        // We generate a ratio * seconds in granularity worth of data into a PlainPBStoragePlugin with different granularity.
        ...
        Instant startTime = ZonedDateTime.now().withMonth(9).withDayOfMonth(11).withHour(8).withMinute(12).withSecond(0).withNano(0).toInstant();;
